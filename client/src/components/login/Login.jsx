  ...
  return (
    <div>
      <Container component="main" maxWidth="xs" className='login-container' sx={{ width: 500, height: 500, marginTop: 20, boxShadow: 5 }}>
        ...
        >
          {isAdmin && (
            <Typography sx={{ fontSize: 32, color: "red", mt: 3, mb: 3 }}> Hello Admin ! </Typography>
          )}
          ...
          <Typography variant="h5">
            Login <LoginIcon sx={{ color: "green", marginLeft: 1 }} />
          </Typography>
          <Box sx={{ marginTop: 3 }}>
            ...
            <Button
              ...
              disabled={loading}
            >
              {loading ? <CircularProgress size={30} sx={{ color: 'green' }} /> : "Login"}
            </Button>
            ...
            {!isAdmin && (
              <center>
                <Typography color="grey" sx={{ fontSize: 18, marginTop: 4 }}>
                  ...
                  <Button sx={{ fontSize: 18 }} onClick={() => { navigate("/register"); }}>
                    <Link> Register </Link>
                  </Button>
                </Typography>
              </center>
